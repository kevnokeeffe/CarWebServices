...
public class UsersFacadeREST extends AbstractFacade<Users> {
    ...
    @GET
    // Path Reference
    @Path("findByIDAndPassword/{userID}/{password}")
    // Produces Reference in relation to how the client consumes the data
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    // Method to allow the brouser to access the parameters
    public List<Users> findByIDAndPassword(@PathParam("userID") int userID, @PathParam("password") String password) {
        return super.findByIDAndPassword(userID, password);
    }
